                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Insert new Category Tree | Turkish - English</h4>
                                    </div>
                                    <div class="widget-body">

                                        <form name="form1" method="POST" action="insert/en/importtren.php">
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" placeholder="Turkish" name="turkish" required>
    </div>
    <div class="col">
      <input type="text" class="form-control" placeholder="English" name="english" required>
    </div>
    ...
    <li class="page-item"><a class="page-link" href="#">Next</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Insert new Category | Turkish - English</h4>
                                    </div>
                                    <div class="widget-body">

                                        <form name="form2" method="POST" action="insert/en/importtren2.php">
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" placeholder="Turkish" name="turkish2" required>
    </div>
    <div class="col">
      <input type="text" class="form-control" placeholder="English" name="english2" required>
    </div>
    <button type="submit" class="btn btn-primary mb-2" name="add2">Add</button>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Insert new Color | Turkish - English</h4>
                                    </div>
                                    <div class="widget-body">

                                        <form name="form3" method="POST" action="insert/en/importtren3.php">
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" placeholder="Turkish" name="turkish3" required>
    </div>
    <div class="col">
      <input type="text" class="form-control" placeholder="English" name="english3" required>
    </div>
