            ...
            $(document).ready(function(){
                ...
                $("#selectxmlfile").change(function(){
                      xml = $(this).val();
                        ...
                        $.ajax({
                            url: 'ajaxgetnode.php',
                            type: 'POST',
                            data: {selectfile:xml,getfunction1:"outputnode"},
                            dataType: 'json',
                ...
                $("#selectnode1").change(function(){
                    ...
                    $.ajax({
                        ...
                        //url: 'test123.php',
                        type: 'POST',
                        //data: {depart:node,selectfile:xml},
                        data: {depart:node,selectfile:xml,getfunction2:"outputnodevalue"},
                        dataType: 'json',
                        success:function(response){
...
<div class="widget has-shadow" style="margin-top: 20px;padding: 20px;">
   <!--  <form action="" method="post" style="margin-left:20px;"> -->
        ...
        <div class="input-group mb-3">
            ...
            <!-- <button type="submit" class="btn btn-outline-primary" name="press">Press</button> -->
        </div>
    </div>
...
<div class="input-group mb-3">
    ...
    <select class="custom-select" id="selectnode1" name="node_selected1">
       ...
       <option selected>Choose XML Node </option>
