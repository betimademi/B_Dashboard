...
<html lang="en">
    ...
    <body id="page-top">
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Output XML</h2>
	                                <div>
			                            <ul class="breadcrumb">
        ...
        require 'translate.php';
            ...
            $dom = new DOMDocument();
            $file = (dirname(__FILE__).'/uploads/SQifondi.xml');
            if (file_exists($file)){
            $dom->load($file);
            ...
            foreach ($nodeThree as $kategoriTree) {
               ...
               foreach ($c as $value) {
                ...
                echo '<div class="col-2">';
                echo '<ul class="list-group list-group-flush">';
                echo '<li class="list-group-item list-group-item-primary">CATEGORY</li>';
                foreach ($k as $kat) {
                ...
                echo '<div class="col">';
                echo '<ul class="list-group list-group-flush">';
                echo '<li class="list-group-item list-group-item-primary">CATEGORY TREE</li>';
                foreach ($kt as $tree) {
