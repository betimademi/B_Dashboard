...
<html lang="en">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="table-responsive">
                                           ...
                                           <?php
                                            $json=file_get_contents('http://bifeks.website/spacebif/api/products?ws_key=QG6NM8GS9L27BVWNP6X9LLM2EFPPLG4H&output_format=JSON');
                                            ...
                                            echo '<table class="table mb-0">';
                                                        ...
                                                        if ($row==0)
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><select style="width:75px;">
  <option value="" selected> -------- </option>
  <option value="">PROD_#</option>
  <option value="">PROD_NAME</option>
  <option value="">IS_PUBLISHED</option>
  <option value="">TYPE_OF</option>
  <option value="">SKU#</option>
  <option value="">PROD_DESCRIPTION</option>
  <option value="">PROD_PRICE</option>
  <option value="">STOCK_QUANTITY</option>
  <option value="">IS_IN_STOCK</option>
</select></th>
                                                        <th><select style="width:75px;">
  <option value="" selected> -------- </option>
  <option value="">PROD_#</option>
  ...
  <option value="">IS_IN_STOCK</option>
                                                    ...
                                                    $jsonp=file_get_contents('http://bifeks.website/spacebif/api/products/'.$p->id.'?ws_key=QG6NM8GS9L27BVWNP6X9LLM2EFPPLG4H&output_format=JSON');
                                            ...
                                            foreach($data as $k) {
                                                ...
                                                echo "<td>$k->active</td>";
                                                echo "<td>$k->type</td>";
                                                echo "<td>".substr($k->description, 0, 70)."</td>";
                                                echo "<td>$k->price</td>";
                                                echo "<td>$k->quantity</td>";
                                                echo "<td>$k->available_now</td>";
                    ...
                    <footer class="main-footer">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-xl-start justify-content-lg-start justify-content-md-start justify-content-center">
                                <p class="text-gradient-02">Design By Bifeks</p>
                            </div>
