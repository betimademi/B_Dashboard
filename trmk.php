                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Insert new Category Tree | Turkish - Macedonian</h4>
                                    </div>
                                    <div class="widget-body">

                                        <form name="form1" method="POST" action="insert/mk/allimport.php">
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" placeholder="Turkish" name="turkish1" required>
    </div>
    <div class="col">
      <input type="text" class="form-control" placeholder="Macedonian" name="macedonian" required>
    </div>
    ...
    <li class="page-item"><a class="page-link" href="#">Next</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Insert new Category | Turkish - Macedonian</h4>
                                    </div>
                                    <div class="widget-body">

                                        <form name="form2" method="POST" action="insert/mk/allimport2.php">
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" placeholder="Turkish" name="turkish2" required>
    </div>
    <div class="col">
      <input type="text" class="form-control" placeholder="Macedonian" name="macedonian2" required>
    </div>
    <button type="submit" class="btn btn-primary mb-2" name="add2">Add</button>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Insert new Color | Turkish - Macedonian</h4>
                                    </div>
                                    <div class="widget-body">

                                        <form name="form3" method="POST" action="insert/mk/allimport3.php">
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" placeholder="Turkish" name="turkish3" required>
    </div>
    <div class="col">
      <input type="text" class="form-control" placeholder="Macedonian" name="macedonian3" required>
    </div>
