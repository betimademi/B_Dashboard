...
$mail->Subject = 'MODAMOSS UPDATE STOCK!';
$mail->isHTML(true);
$mail->Body = '<html><body><p><b>The MODAMOSS STOCK HAS BEEN UPDATED</b></p><p><i>Please check the CSV file for details</i></p></body></html>';
...
//$filename = 'stokfiles/ModamossStockUpdated'.date('d-h-i').'.csv';
$filename = 'stokfiles/ModamossStockUpdated.csv';
