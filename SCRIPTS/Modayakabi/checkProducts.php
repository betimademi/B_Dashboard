...
<?php
if (file_exists('oldmodayakabi.xml')) {
...
if (file_exists('newmodayakabi.xml')){
 ...
 foreach($oldxml->xpath('Urunler/Urun') as $oldproduct) {
                ...
                if(!(in_array($x, $newproductsarray))) {
                    ...
                    echo '<td>' . $oldproduct->Barkod . '</td>';
                    echo '<td>' . $oldproduct->StokAdedi . '</td>';
                    echo '</tr>';
                }
            }
            unset($oldproduct);//End the loop
             ...
             foreach($newxml->xpath('Urunler/Urun') as $newproduct){
                ...
                if(!(in_array($y, $oldproductsarray))) {
                    ...
                    echo '<td>' . $newproduct->Barkod . '</td>';
                    echo '<td>' . $newproduct->StokAdedi . '</td>';
                    echo '</tr>';
                }
            }
